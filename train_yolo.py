...
# model_path = r"C:\projexts\banana_classification\runs\detect\banana_ripeness_detector13\weights\last.pt"
...
#     imgsz=640,
#     batch=16,
#     name='banana_ripeness_detector13',  # ใช้ชื่อเดิม
#     resume=True
# )
...
#        ถ้า RAM น้อย ให้ลดค่า batch ลง เช่น 8, 4
# name: ชื่อของ run การฝึกนี้ ผลลัพธ์จะถูกบันทึกใน runs/detect/your_run_name
results = model.train(data=data_yaml_path, epochs=60, imgsz=640, batch=16, name='banana_ripeness_detector')
